...
public class LibraryManagementSystem {
    ...
    static final String PASS = "Nagaaditya@123";
    ...
    private static void addBook(Statement stmt, Scanner scanner) throws SQLException {
        ...
        String addBookSQL = "INSERT INTO books (name, author, issue_status) VALUES ('" + name + "', '" + author + "', 'available')";
    ...
    private static void issueReturnBook(Statement stmt, Scanner scanner) throws SQLException {
        ...
        if (rs.next()) {
            ...
            if (issueStatus.equals("available")) {
                ...
                String issueBookSQL = "UPDATE books SET issue_status = 'issued', student_id = " + studentId + ", due_date = '" + dueDate + "' WHERE id = " + bookId;
                stmt.executeUpdate(issueBookSQL);

                System.out.println("Book issued successfully.");
            } else if (issueStatus.equals("issued")) {
                String returnBookSQL = "UPDATE books SET issue_status = 'available', student_id = NULL, due_date = NULL WHERE id = " + bookId;
    ...
    private static void viewBooksIssuedToStudent(Statement stmt, Scanner scanner) throws SQLException {
        ...
        while (rs.next()) {
            ...
            System.out.println("Book ID: " + bookId + ", Name: " + bookName + ", Author: " + author + ", Status: " + issueStatus);
        }
    }
    ...
    private static void checkIssuedBooksStatus(Statement stmt, Scanner scanner) throws SQLException {
        ...
        while (rs.next()) {
            ...
            System.out.println("Book ID: " + bookId + ", Name: " + bookName + ", Author: " + author + ", Due Date: " + dueDate);
        }
    }
}